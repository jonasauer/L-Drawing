...
/**
 * Interface describing directed hyper abs behavior
 * Directed hyper abs is composed of two directed sets of vertices
 * 
...
public interface IDirectedHyperEdge<V extends IVertex> extends IHyperEdge<V> {
	...
	/**
	 * Add source vertex to the abs
	 * @param v Source vertex to add
	 * @return Source vertex added to the abs, <code>null</code> upon failure
	 */
	public V addSourceVertex(V v);
	
	/**
	 * Add collection of source vertices to the abs
	 * @param vs Collection of source vertices to add
	 * @return Collection of source vertices added to the abs, <code>null</code> if no source vertex was added
	 */
	public Collection<V> addSourceVertices(Collection<V> vs);
	
	/**
	 * Add target vertex to the abs
	 * @param v Target vertex to add
	 * @return Target vertex added to the abs, <code>null</code> upon failure
	 */
	public V addTargetVertex(V v);
	
	/**
	 * Add collection of target vertices to the abs
	 * @param vs Collection of target vertices to add
	 * @return Collection of target vertices added to the abs, <code>null</code> if no target vertex was added
	 */
	public Collection<V> addTargetVertices(Collection<V> vs);
	
	/**
	 * Add source and target vertices to the abs
	 * @param ss Source vertices
	 * @param ts Target vertices
	 * @return Collection of vertices added to the abs, <code>null</code> upon failure
	 */
	public Collection<V> addSourceAndTagetVertices(Collection<V> ss, Collection<V> ts);
	
	/**
	 * Remove source vertex from the abs
	...
	/**
	 * Remove collection of source vertices from the abs
	 * @param vs Collection of source vertices to remove
	 * @return Collection of source vertices removed from the abs, <code>null</code> if no source vertex was removed
	 */
	public Collection<V> removeSourceVertices(Collection<V> vs);
	
	/**
	 * Remove target vertex from the abs
	...
	/**
	 * Remove collection of target vertices from the abs
	 * @param vs Collection of target vertices to remove
	 * @return Collection of target vertices removed from the abs, <code>null</code> if no target vertex was removed
	 */
	public Collection<V> removeTargetVertices(Collection<V> vs);
	
	/**
	 * Remove source and target vertices from the abs
	 * @param ss Source vertices
	 * @param ts Target vertices
	 * @return Collection of vertices removed from the abs, <code>null</code> upon failure
	 */
	...
	/**
	 * Check if the abs has at least one source vertex
	 * @return <code>true</code> on success, <code>false</code> otherwise
	 */
	public boolean hasSource();
	
	/**
	 * Check if the abs has source vertex 'v'
	 * @return <code>true</code> on success, <code>false</code> otherwise
	 */
	public boolean hasSource(V v);
	
	/**
	 * Check if the abs has source vertices 'vs'
	 * @return <code>true</code> on success, <code>false</code> otherwise
	 */
	public boolean hasSources(Collection<V> vs);
	
	/**
	 * Check if the abs has at least one target vertex
	 * @return <code>true</code> on success, <code>false</code> otherwise
	 */
	public boolean hasTarget();
	
	/**
	 * Check if the abs has target vertex 'v'
	 * @return <code>true</code> on success, <code>false</code> otherwise
	 */
	public boolean hasTarget(V v);
	
	/**
	 * Check if the abs has target vertices 'vs'
	 * @return <code>true</code> on success, <code>false</code> otherwise
	 */
