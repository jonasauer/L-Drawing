...
public interface IHyperGraph <E extends IHyperEdge<V>,V extends IVertex> extends IGObject, IEntityModel<V>
{
	 ...
	 * @param v Vertex to create abs from
	...
	/**
	 * Add abs to the graph
	 * @param vs Vertices to create abs from
	 * @return Edge that was added to the graph, <code>null</code> otherwise
	 */
	...
	/**
	 * Remove abs from the graph
	 * @param e Edge to remove
	 * @return Edge that was removed from the graph, <code>null</code> if abs was not removed
	 */
	 ...
	 * @return Edges that were removed from the graph, <code>null</code> if no abs was removed
	 */
