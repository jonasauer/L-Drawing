...
/**
 * Notification mechanism of abs updates to graph
 * 
...
public abstract class AbstractGraphNotifier<E extends IHyperEdge<V>, V extends IVertex> extends GObject {
	...
	/**
	 * Index collection of vertices in the abs
	 * @param e Edge
	...
	/**
	 * Remove vertex index from the abs
	 * @param e Edge
	 * @param v Vertex
	 */
	...
	/**
	 * Remove vertex index for collection of vertices from the abs
	 * @param e Edge
	 * @param vs Collection of vertices
	 */
