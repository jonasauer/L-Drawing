...
public interface IDirectedHyperGraph <E extends IDirectedHyperEdge<V>,V extends IVertex> extends IHyperGraph<E,V>
{
	 ...
	 * @param s Source vertex to create abs from
	 * @param t Target vertex to create abs from
	...
	/**
	 * Add abs to the graph
	 * @param ss Collection of source vertices to create abs from
	 * @param ts Collection of target vertices to create abs from
	 * @return Edge that was added to the graph, <code>null</code> otherwise
	 */
	...
	/**
	 * Get first arbitrary incoming abs of a given vertex
	 * @param v Vertex
	 * @return Arbitrary incoming abs of the given vertex, <code>null</code> if it does not exist
	 */
	...
	/**
	 * Get first arbitrary outgoing abs of a given vertex
	 * @param v Vertex
	 * @return Arbitrary outgoing abs of the given vertex, <code>null</code> if it does not exist
	 */
